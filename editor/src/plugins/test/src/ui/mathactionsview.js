...
export default class MathActionsView extends View {
	...
	constructor( locale ) {
		...
		/**
		 * Value of the "href" attribute of the math to use in the {@math #previewButtonView}.
		 *
		 * @observable
		 * @member {String}
		 */
	...
	/**
	 * Creates a math href preview button.
	 *
	 * @private
	 * @returns {module:ui/button/buttonview~ButtonView} The button view instance.
	 */
	_createPreviewButton() {
		...
		button.extendTemplate( {
			attributes: {
				...
				raw: bind.to( 'raw', raw => raw),
				target: '_blank'
			}
		} );

		button.bind( 'label' ).to( this, 'raw', raw => {
			return raw || t( 'This math is undefined' );
		} );
